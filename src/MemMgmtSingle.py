...
class MemMgmtOptRLFairTrain(MemMgmt):
    ...
    def run(self):
        if self.diskMode == "ReadFromDisk":
            ...
            trainDataLogPd = pd.read_csv("/home/hesun_azure/hesun/rl_fairness/hist/PipelineRLFairVis/2022-10-07-02-15-44-269915/data/MemMgmtOptRLFairTrain/MemMgmtOptRLFairTraintrainDataLogPd.csv")#for dp sim data
